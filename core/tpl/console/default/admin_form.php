                            ...
                            <?php foreach ($this->profile as $key=>$value) { ?>
                                <div class="form-check">
                                    <label for="admin_allow_profile_<?php echo $key; ?>" class="form-check-label">
                                        <input type="checkbox" name="admin_allow_profile[<?php echo $key; ?>]" id="admin_allow_profile_<?php echo $key; ?>" value="1" <?php if (isset($this->tplData['adminRow']['admin_allow'][$key])) { ?>checked<?php } ?> class="form-check-input">
