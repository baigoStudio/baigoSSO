    ...
    <form name="upgrade_form_admin" id="upgrade_form_admin">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <a href="<?php echo BG_URL_INSTALL; ?>index.php?m=upgrade&a=auth" class="btn btn-info"><?php echo $this->lang['mod']['href']['adminAuth']; ?></a>
            </div>
...
<?php include($cfg['pathInclude'] . 'install_foot.php'); ?>
    ...
    var opts_validator_form = {
        admin_name: {
            ...
            ajax: { url: "<?php echo BG_URL_INSTALL; ?>index.php?m=upgrade&c=request&a=chkname", key: "admin_name", type: "str" }
        },
        admin_pass: {
            len: { min: 1, max: 0 },
