                        ...
                        <?php for ($_iii = 1; $_iii <= 3; $_iii++) { ?>
                            ...
                            <div class="form-group">
                                <div id="group_admin_sec_ques_<?php echo $_iii; ?>">
                                    <label class="control-label"><?php echo $this->lang["label"]["secQues"]; ?> <?php echo $_iii; ?><span id="msg_admin_sec_ques_<?php echo $_iii; ?>">*</span></label>
                                    <div class="row">
                            ...
                            <div class="form-group">
                                <div id="group_admin_sec_answ_<?php echo $_iii; ?>">
                                    <label class="control-label"><?php echo $this->lang["label"]["secAnsw"]; ?> <?php echo $_iii; ?><span id="msg_admin_sec_answ_<?php echo $_iii; ?>">*</span></label>
                                    <div class="row">
                                        <div class="col-sm-7 col-xs-6">
