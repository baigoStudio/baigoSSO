	...
	<p>
		<img src="./zh_CN/help/image/opt_reg.jpg" class="img-responsive img-rounded img_border">
	</p>

	<div class="panel panel-default">
		<div class="panel-heading">填写说明</div>
		<div class="panel-body">
			<h4 class="text-info">强制输入 E-mail</h4>
			<p>如此项开启，用户在注册时必须输入 E-mail 地址。</p>

			<h4 class="text-info">允许 E-mail 地址重复</h4>
			<p>如选择是，则允许用户注册是，重复使用 E-mail 地址。</p>

			<h4 class="text-info">允许注册的 E-mail</h4>
