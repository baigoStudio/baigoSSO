...
break;default:$(modal_selector).modal('hide');obj_form.find(opts.selector.submit_btn).removeAttr('disabled');break;}},submitFunc:function(callback){var _str_conn;if(typeof opts.ajax_url=='undefined'||opts.ajax_url==''){opts.ajax_url=obj_form.attr('action');}
