	...
	<p>
		使用 API 接口，您需先在 baigo SSO 创建应用，创建成功后会给出 APP ID 和 APP KEY。详情查看 <a href="?lang=zh_CN&mod=help&act=app#show">查看应用</a>。
	</p>
	...
	<h3>应用的验证</h3>
	<p>
		baigo SSO 的所有 API 接口均需要验证应用以及验证应用的权限。详情请参照具体接口说明。
	</p>
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="nowrap">string</td>
						<td>解密码，配合加密字符串使用，用于解码。详情请看 <a href="?lang=zh_CN&mod=api&act=code">密文接口</a>。</td>
					</tr>
				</tbody>
			</table>
		</div>
