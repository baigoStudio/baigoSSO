...
class MODEL_USER {
    ...
    function input_user($arr_userInput) {
        if (isset($arr_userInput['user_id'])) {
            $_arr_userInput['user_by']     = 'user_id';
            $_arr_userChk                = $this->chk_user_id($arr_userInput['user_id']);
        } else if (isset($arr_userInput['user_name'])) {
            $_arr_userInput['user_by']     = 'user_name';
            $_arr_userChk                = $this->chk_user_name($arr_userInput['user_name']);
        } else if (isset($arr_userInput['user_mail']) && BG_LOGIN_MAIL == 'on') {
            $_arr_userInput['user_by']     = 'user_mail';
            $_arr_userChk                = $this->chk_user_mail($arr_userInput['user_mail']);
        } else {
    ...
    function input_submit() {
        ...
        $this->userInput['user_contact'] = fn_jsonEncode($_arr_userContact, true);

        $_arr_userExtend  = fn_post('user_extend');
        $this->userInput['user_extend'] = fn_jsonEncode($_arr_userExtend, true);
