...
class CLASS_INSTALL {
    ...
    function __construct() { //构造函数
        ...
        $this->obj_tpl->ext = fn_include(BG_PATH_INC . DS . 'php_lib.inc.php');
        ...
        $this->obj_tpl->lang = array(
            ...
            'ext'       => fn_include(BG_PATH_LANG . $this->config['lang'] . DS . 'ext.php'), //菜单
        ...
        if (file_exists(BG_PATH_LANG . $this->config['lang'] . DS . 'install' . DS . $GLOBALS['mod'] . '.php')) {
            $this->obj_tpl->lang['mod'] = fn_include(BG_PATH_LANG . $this->config['lang'] . DS . 'install' . DS . $GLOBALS['mod'] . '.php');
        }
    }
}
