...
<pre><code class=\"language-javascript\">{
    ...
    &quot;urlRows&quot;: [ //通知 URL
        {
            &quot;url&quot;: &quot;http://abc.com/api/api.php?mod=sync&quot;,
            &quot;date&quot;: &quot;act_get=login&amp;time=1446527788&amp;random=sdfwerwer&amp;signature=sdfdsfsdrewerwugroe7treie&amp;code=CSMEIFh7AHYBOFIlXQwAaQE0UXENawF2WUxXUbg1zASk%3D&amp;key=tLUwyt&quot;
        },
        {
            &quot;url&quot;: &quot;http://123.cn/api/api.php?mod=sync&quot;,
            &quot;date&quot;: &quot;act_get=login&amp;time=1446527788&amp;random=sdfwerwer&amp;signature=sdfdsfsdrewerwugroe7treie&amp;code=CSMEIFh7AHYBOFIlXQwAaQE0UXENawF2WUxXUbg1zASk%3D&amp;key=tLUwyt&quot;
        }
    ]
}</code></pre>
...
$(document).ready(function(){
	&lt;?php foreach (\$sync[&quot;urlRows&quot;] as \$key=&gt;\$value) { ?&gt;
		\$.ajax({
			url: &quot;&lt;?php echo \$value[&quot;url&quot;] ?&gt;&quot;, //url
			data: &quot;&lt;?php echo \$value[&quot;data&quot;] ?&gt;&quot;, //data
			type: &quot;post&quot;, //方法
...
&lt;/script&gt;</code></pre>
	...
	<p class=\"text-success\">接口说明</p>
	<p>应用调用同步接口以后，将会直接访问“通知接口 URL”，并且将通知的数据 POST 给该 URL，即上一步通过 AJAX 提交的例子。</p>
...
<pre><code class=\"language-javascript\">{
	...
	<p class=\"text-success\">接口说明</p>
	<p>应用调用同步接口以后，将会直接访问“通知接口 URL”，并且将通知的数据 POST 给该 URL。</p>
