                ...
                <div class="well">
                    ...
                    <div class="form-group">
                        ...
                        <?php foreach ($this->profile as $key=>$value) { ?>
                            <div class="bg-checkbox">
                                <label for="admin_allow_<?php echo $key; ?>">
                                    <input type="checkbox" name="admin_allow[<?php echo $key; ?>]" id="admin_allow_<?php echo $key; ?>" value="1" <?php if (isset($this->tplData['adminRow']['admin_allow'][$key])) { ?>checked<?php } ?>>
