...
return array(
    ...
    'Fill in the domain, one domain per line, such as: <code>@hotmail.com</code>'       => '只填域名部分，每行一个域名，如 <code>@hotmail.com</code>',
    'Turning on this, you need to verify the email when you register or replace it'     => '注册或更换邮箱均需要验证',
    'One username per line, use wildcard <kbd>*</kbd> such as: <code>*master*</code>'   => '每行一个用户名，可使用通配符 <kbd>*</kbd>，如 <code>*master*</code>',
);
