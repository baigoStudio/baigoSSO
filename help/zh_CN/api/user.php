			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="nowrap">string</td>
						<td class="nowrap"></td>
						<td>视注册设置情况而定。详情查看 <a href="?zh_CN&mod=help&act=opt#reg">注册设置</a>。</td>
					</tr>
					<tr>
	...
	<p>
		baigo SSO 所有 API 接口均返回加密字符串，真正内容需要调用密文接口进行解密。详情请看 <a href="?lang=zh_CN&mod=api&act=code">密文接口</a>。
	</p>
