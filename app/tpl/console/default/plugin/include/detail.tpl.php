  ...
  <div class="form-group">
    <label class="text-muted font-weight-light"><?php echo $lang->get('Class'); ?></label>
    <div class="form-text font-weight-bolder">
  ...
  <div class="form-group">
    <label class="text-muted font-weight-light"><?php echo $lang->get('Version'); ?></label>
    <div class="form-text font-weight-bolder">
  ...
  <div class="form-group">
    ...
    <div class="form-text font-weight-bolder">
      <?php if (isset($pluginRow['plugin_config']['author'])) {
        if (isset($pluginRow['plugin_config']['author_url']) && !empty($pluginRow['plugin_config']['author_url'])) { ?>
  ...
  <div class="form-group">
    <label class="text-muted font-weight-light"><?php echo $lang->get('Detail'); ?></label>
    <p class="bg-content">
