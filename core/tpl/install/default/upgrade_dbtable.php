...
include($cfg['pathInclude'] . "dbtable.php"); ?>
    ...
    <div class="form-group clearfix">
        <div class="pull-left">
            <div class="btn-group">
                <a href="<?php echo BG_URL_INSTALL; ?>index.php?mod=upgrade&act=dbconfig" class="btn btn-default"><?php echo $this->lang['mod']['btn']['stepPrev']; ?></a>
        ...
        <div class="pull-right">
            <a href="<?php echo BG_URL_INSTALL; ?>index.php?mod=upgrade&act=base" class="btn btn-primary"><?php echo $this->lang['mod']['btn']['stepNext']; ?></a>
        </div>
    </div>
