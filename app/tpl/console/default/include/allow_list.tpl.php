    ...
    <dl>
        ...
        foreach ($config['console']['console_mod'] as $_key_m=>$_value_m) { ?>
            ...
            <dd>
                ...
                foreach ($_value_m['allow'] as $_key_s=>$_value_s) {
                    ...
                    <?php } else { ?>
                        <span>
                            <span class="fas fa-<?php if (isset($_arr_adminRow['admin_allow'][$_key_m][$_key_s]) || $_arr_adminRow['admin_type'] == 'super') { ?>check-circle text-success<?php } else { ?>times-circle text-danger<?php } ?>"></span>
                            <?php echo $lang->get($_value_s, 'console.common'); ?>
                        </span>
                    <?php }
                } ?>
        ...
        <dd>
            ...
            foreach ($config['console']['opt'] as $_key_s=>$_value_s) {
                ...
                <?php } else { ?>
                    <span>
                        <span class="fas fa-<?php if (isset($_arr_adminRow['admin_allow']['opt'][$_key_s]) || $_arr_adminRow['admin_type'] == 'super') { ?>check-circle text-success<?php } else { ?>times-circle text-danger<?php } ?>"></span>
                        <?php echo $lang->get($_value_s['title'], 'console.common'); ?>
                    </span>
                <?php }
            } ?>
