...
class CLASS_CONSOLE {
    ...
    function __construct() { //构造函数
        ...
        $this->obj_tpl->consoleMod  = fn_include(BG_PATH_INC . DS . 'consoleMod.inc.php'); //菜单配置文件
        $this->obj_tpl->profile     = fn_include(BG_PATH_INC . DS . 'profile.inc.php'); //菜单配置文件
        ...
        $this->obj_tpl->lang = array(
            ...
            'consoleMod'    => fn_include(BG_PATH_LANG . $this->config['lang'] . DS . 'console' . DS . 'consoleMod.php'), //菜单
        );

        if (file_exists(BG_PATH_LANG . $this->config['lang'] . DS . 'console' . DS . $GLOBALS['mod'] . '.php')) {
            $this->obj_tpl->lang['mod'] = fn_include(BG_PATH_LANG . $this->config['lang'] . DS . 'console' . DS . $GLOBALS['mod'] . '.php');
        }
    }
