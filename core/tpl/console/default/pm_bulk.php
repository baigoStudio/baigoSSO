                ...
                <div class="form-group">
                    <div id="bulkUsers" class="bulk_types">
                        <div id="group_pm_to_users">
                            ...
                            <p class="help-block"><?php echo $this->lang["label"]["toNote"]; ?></p>
                        </div>
                    </div>
                    ...
                    <div id="bulkKeyName" class="bulk_types">
                        <div id="group_pm_to_key_name">
                            ...
                            <p class="help-block"><?php echo $this->lang["label"]["keyNameNote"]; ?></p>
                        </div>
                    </div>
                    ...
                    <div id="bulkKeyMail" class="bulk_types">
                        <div id="group_pm_to_key_mail">
                            ...
                            <p class="help-block"><?php echo $this->lang["label"]["keyMailNote"]; ?></p>
                        </div>
                    </div>
                    ...
                    <div id="bulkRangeId" class="bulk_types">
                        <div id="group_pm_to_range_id">
                            ...
                            <p class="help-block"><?php echo $this->lang["label"]["rangeIdNote"]; ?></p>
                        </div>
                    </div>
                    ...
                    <div id="bulkRangeTime" class="bulk_types">
                        <div id="group_pm_to_range_time">
                            ...
                            <p class="help-block"><?php echo $this->lang["label"]["rangeTimeNote"]; ?></p>
                        </div>
                    </div>
                    ...
                    <div id="bulkRangeLogin" class="bulk_types">
                        <div id="group_pm_to_range_login">
                            ...
                            <p class="help-block"><?php echo $this->lang["label"]["rangeLoginNote"]; ?></p>
                        </div>
                    </div>
                </div>
