/*
v0.2.0 jQuery baigoUbb plugin UBB 编辑器
    ...
    $.fn.baigoUbb = function(options) {
        ...
        var el = {
            ...
            insertTag: function(tag, value) {
                ...
                if (typeof tag != 'undefined' && tag.length > 0 && typeof value != 'undefined') {
                    var _insert = '[' + tag;
                            ...
                            $.each(value, function(_key, _value){
                                if (typeof _value == 'string') {
                                    if (typeof _key == 'string') {
                                        if (_key == tag) {
                                            _add_tag = ']' + _value;
                                        } else if (typeof opts.dialog[tag].ext[_key].ignore != 'undefined' && opts.dialog[tag].ext[_key].ignore == true) {
                                            _add_ext += '=' + _value;
                                        } else {
                                            _add_ext += ' ' + _key + '=' + _value;
                                        }
                                    }
                                }
                            });

                            _insert += _add_ext + _add_tag;
                        }
        ...
        $(opts.menu_selector).on('click', '.bg-dialog', function(){
            ...
            if (typeof opts.dialog[_tag] != 'undefined') {
                if (typeof opts.dialog[_tag] == 'string') {
                    var _input = opts.dialog[_tag];
                } else if (typeof opts.dialog[_tag] == 'object') {
                    if (typeof opts.dialog[_tag].ext == 'object' || typeof opts.dialog[_tag].ext == 'string') {
                        var _input = opts.dialog[_tag].ext;
                    } else if (typeof opts.dialog[_tag].text == 'string') {
                        var _input = opts.dialog[_tag].text;
                    }
                }
