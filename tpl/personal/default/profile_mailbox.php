...
include($cfg['pathInclude'] . 'personal_head.php'); ?>
    ...
    <form name="mailbox_form" id="mailbox_form">
        ...
        <div class="form-group">
            <label><?php echo $this->lang['mod']['label']['mailNew']; ?></label>
            <div class="form-text form-control-lg"><?php echo $this->tplData['verifyRow']['verify_mail']; ?></div>
        </div>
...
<?php include($cfg['pathInclude'] . 'personal_foot.php'); ?>
    ...
    var opts_submit_form = {
        ajax_url: "<?php echo BG_URL_PERSONAL; ?>index.php?m=profile&c=request",
        msg_text: {
    ...
    $(document).ready(function(){
        var obj_validator_form    = $("#mailbox_form").baigoValidator(opts_validator_form, options_validator_form);
