                            ...
                            <dl class="list_dl">
                                ...
                                <dd>
                                    ...
                                    <label for="allow_opt_dbconfig" class="checkbox-inline">
                                        <input type="checkbox" name="admin_allow[opt][dbconfig]" value="1" id="allow_opt_dbconfig" class="allow_opt" {if isset($tplData.adminRow.admin_allow.opt.dbconfig)}checked{/if}>
