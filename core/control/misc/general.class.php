...
class GENERAL_MISC {
    ...
    function __construct() { //构造函数
        ...
        if (file_exists(BG_PATH_LANG . $this->config['lang'] . DS . 'misc' . DS . $GLOBALS['route']['bg_mod'] . '.php')) {
            $this->obj_tpl->lang['mod'] = fn_include(BG_PATH_LANG . $this->config['lang'] . DS . 'misc' . DS . $GLOBALS['route']['bg_mod'] . '.php');
        }
    }
}
