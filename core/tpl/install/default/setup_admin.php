...
include($cfg['pathInclude'] . 'setup_head.php'); ?>
    ...
    <div class="form-group">
        <a href="<?php echo BG_URL_INSTALL; ?>index.php?mod=setup&act=auth" class="btn btn-info"><?php echo $this->lang['mod']['href']["adminAuth"]; ?></a>
    </div>
    ...
    <form name="setup_form_admin" id="setup_form_admin">
        ...
        <div class="form-group clearfix">
            <div class="pull-left">
                <div class="btn-group">
                    <a href="<?php echo BG_URL_INSTALL; ?>index.php?mod=setup&act=smtp" class="btn btn-default"><?php echo $this->lang['mod']['btn']['stepPrev']; ?></a>
